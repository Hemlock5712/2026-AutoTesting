...
public class AutoRoutines {
    ...
    private static final double BUMPERS_ON_LINE = 4.378; // Under trench, bumpers just barely on the line, starting X
     ...
     *
     * <p>
     * Drives a simple S-curve path to verify FollowPath works in simulation. Start
     * at (1, 4),
     * curve to the right, then back to center, ending at (7, 4).
     */
    public Command pathFollowTestAuto() {
        SplinePath testPath = new SplinePath(
     ...
     *
     * <p>
     * Follows the LEFT path with heading waypoints and constraint zones.
     * Automatically mirrors for
    ...
    public Command pathEditorTestAuto() {
        ...
        Rotation2d startHeading = pathData.headingWaypoints().isEmpty()
                ? Rotation2d.kZero
     ...
     *
     * <p>
     * Demonstrates using AndWait variants to ensure mechanisms are ready before
     * continuing. Good
        ...
        return Commands.sequence(
                ...
                new ParallelDeadlineGroup(
                        new SequentialCommandGroup(
                                autoCommands
                                        .driveTo(
                                                () -> new ExtPose(0.744, RIGHT_TRENCH_CENTER,
    ...
    public Command throughRightTrench(boolean centerToZone) {
        return Commands.either(
                Commands.sequence(
                        ...
                        autoCommands
                                .driveTo(
                                        () -> new ExtPose(5.959, RIGHT_TRENCH_CENTER, Rotation2d.fromDegrees(-180))
                                                .get())
                                .withWaypoint(0.2)
                                .withMaxSpeed(3)
                        ...
                        autoCommands
                                .driveTo(
                                        () -> new ExtPose(3.517, RIGHT_TRENCH_CENTER, Rotation2d.fromDegrees(180))
                                                .get())
                                .withWaypoint(2)
                                .withMaxSpeed(4)),
                Commands.sequence(
    ...
    public Command throughLeftTrench(boolean centerToZone) {
        return Commands.either(
                Commands.sequence(
                        ...
                        autoCommands
                                .driveTo(
                                        () -> new ExtPose(5.959, LEFT_TRENCH_CENTER, Rotation2d.fromDegrees(-180))
                                                .get())
                                .withWaypoint(0.2)
                                .withMaxSpeed(3)
                                .deadlineFor(superstructure.stopShoot()),
     ...
     * Actions:
     * 
     * - HubShoot: Shoots at the hub
     * - FeedShoot: Shoots in feeding mode
     * - StopShoot: Stops the shooter
     * 
