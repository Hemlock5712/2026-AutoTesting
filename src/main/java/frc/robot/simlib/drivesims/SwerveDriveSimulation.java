...
import frc.robot.simlib.mathutils.GeometryConvertor;
...
public class SwerveDriveSimulation extends AbstractDriveTrainSimulation {
  ...
  private void simulateModulePropellingForces() {
    ...
    final Rotation2d driveRotation =
        getSimulatedDriveTrainPose().getRotation(); // Call it once per 4 modules.
   ...
   * @see frc.robot.simlib.drivesims.configs.SwerveModuleSimulationConfig#maximumGroundSpeed()
   */
   ...
   * @see frc.robot.simlib.drivesims.configs.SwerveModuleSimulationConfig#maxAcceleration(Mass, int,
   *     Current)
   */
