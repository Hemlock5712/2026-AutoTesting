package frc.robot.simlib.drivesims;
...
import frc.robot.simlib.mathutils.MapleCommonMath;
...
public class GyroSimulation {
   ...
   * simulation.
   *
   * <p>If you are using this class outside of {@link frc.robot.simlib.SimulatedArena}: make sure to
   * call it 5 times in each robot period (if using default timings), or refer to {@link
   * frc.robot.simlib.SimulatedArena#overrideSimulationTimings(Time, int)}.
   *
