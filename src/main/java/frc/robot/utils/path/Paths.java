...
public final class Paths {
    ...
    public static final Pose2d START_LEFT = new Pose2d(new Translation2d(4.4474222222222215, 7.689296296296297), Rotation2d.fromDegrees(-90));
    public static final Pose2d START_LEFT_MIRROR = new Pose2d(new Translation2d(4.4474222222222215, 0.5207037037037034), Rotation2d.fromDegrees(90));
    public static final PathData START_LEFT_TO_RIGHT_TRENCH_TO_DEPOT = new PathData(
        List.of(
    ...
    public static final PathData START_LEFT_TO_RIGHT_BUMP = new PathData(
        List.of(
            new Translation2d(4.450453608247423, 7.694),
            new Translation2d(7.954546391752578, 7.024917525773197),
    ...
    public static final PathData START_LEFT_TO_RIGHT_BUMP_LONG = new PathData(
        List.of(
            new Translation2d(4.450453608247423, 7.694),
            new Translation2d(7.954546391752578, 7.024917525773197),
            new Translation2d(8.421157465509625, 4.047917648736876),
    ...
    public static final PathData OP = new PathData(
        List.of(
        ...
        List.of(
            ...
            new PathData.WaypointFlag("8f556a15-54ee-4d2c-9bd4-43ab6735bde0", 4, "SlowRaiseIntake"),
            new PathData.WaypointFlag("f24f6185-c700-4454-9f6c-a30e3af2e090", 6, "RunIntake"),
            new PathData.WaypointFlag("f9f15365-3bbe-4175-848b-efc574e2c984", 13, "SlowRaiseIntake")
        )
    );

    public static final PathData OP_RIGHT = new PathData(
        List.of(
    ...
    public static final PathData SHARK = new PathData(
        List.of(
    ...
    public static final PathData MADTOWN = new PathData(
        List.of(
            new Translation2d(4.4474222222222215, 7.689296296296297),
        ...
        List.of(
            ...
            new PathData.WaypointFlag("d5f8ce33-f74d-49f9-9a4e-4ea51de62e07", 4, "SlowRaiseIntake"),
            new PathData.WaypointFlag("78b318b0-3ca1-4199-a3a4-f20f7022e169", 6, "RunIntake"),
            new PathData.WaypointFlag("6ad555ec-19ce-474f-a2de-5eca59a4565f", 13, "SlowRaiseIntake")
        )
    );

    public static final PathData MADTOWN_DOUBLE_BUMP = new PathData(
        List.of(
            new Translation2d(4.4474222222222215, 7.689296296296297),
            new Translation2d(6.209331779186798, 7.133205771424404),
            new Translation2d(7.652345546052205, 5.952558098153318),
        ...
        List.of(
            ...
            new PathData.WaypointFlag("804f8f0a-2487-420b-b371-4962d0bf3b3d", 4, "SlowRaiseIntake"),
            new PathData.WaypointFlag("69576060-0879-476f-8eea-485921af6696", 6, "RunIntake"),
            new PathData.WaypointFlag("efb30369-46e2-4bcd-af3b-bcc09f09e518", 13, "SlowRaiseIntake")
        )
    );
