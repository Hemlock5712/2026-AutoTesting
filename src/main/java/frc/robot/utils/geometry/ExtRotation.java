 ...
 * NetworkTables, and
 * dynamically returns flipped variants of the original rotation based on the
 * robot's current
...
public final class ExtRotation extends ExtGeometry<Rotation2d> {
    ...
    /**
     * Constructs and returns an extended {@link Rotation2d} with the given radian
     * value.
     *
    ...
    /**
     * Constructs and returns an extended {@link Rotation2d} with the given degree
     * value.
     *
    ...
    /**
     * Constructs and returns an extended {@link Rotation2d} with the given
     * rotations value.
     *
