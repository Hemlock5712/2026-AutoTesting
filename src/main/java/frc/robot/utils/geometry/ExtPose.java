 ...
 * NetworkTables, and
 * dynamically returns flipped variants of the original pose based on the
 * robot's current alliance
 * via {@link ExtPose#get()}.
 */
public final class ExtPose extends ExtGeometry<Pose2d> {

    /**
     * Creates an extended {@link Pose2d}. All parameters are expected to be blue
     * origin relative.
     *
