...
abstract class ExtGeometry<T> implements Tunable, Supplier<T> {
  ...
  /**
   * Gets the value for the robot's current alliance. Flipping behavior is inherited from {@link
   ...
   * FieldInfo#symmetryType()}.
   *
   * @param flipWidth If the value should also be flipped over the field's width, regardless of the
   *     robot's alliance.
   */
  ...
  /**
   * Gets the value for the specified alliance. Flipping behavior is inherited from {@link
   * FieldInfo#symmetryType()}.
   *
