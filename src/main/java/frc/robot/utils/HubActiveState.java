...
public class HubActiveState {
  ...
  public static HubActiveState getInstance() {
    return _inst;
  }
  ...
  private final TimeSegment[] TeleopHubActiveTimesForAutoWinner =
      new TimeSegment[] {
  ...
  private final TimeSegment[] TeleopHubActiveTimesForAutoLoser =
      new TimeSegment[] {
  ...
  private final DoublePublisher timeUntilSwapPublisher =
      inst.getDoubleTopic("Time Until Swap").publish();
  ...
  private final HootAutoReplay autoReplay =
      new HootAutoReplay()
          ...
          .withDouble(
              "Hub/Time Until Swap",
              () -> timeUntilTransition,
              val -> timeUntilTransition = val.value);
