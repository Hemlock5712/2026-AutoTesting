...
/**
 * Physics sim implementation of module IO. Sim is always voltage-controlled. Sim runs odometry at
 * the main loop rate (50 Hz) — high-frequency odometry adds nothing in sim and would just be noise.
 */
