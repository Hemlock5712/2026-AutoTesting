...
public final class ShotMapGenerator {
  ...
  public static Generated generate() {
    ...
    return new Generated(
        hoodCoeffs, flywheelGrid, tofGrid, maxHoodRes, feasible, N_DIST * N_VEL);
  }
   ...
   * region; the runtime feasibility gate rejects them, but a filled table keeps interpolation valid.
   */
  ...
  public static void main(String[] args) {
    ...
    System.out.println("// hood max residual: " + String.format("%.3f", gen.maxHoodResidualDeg())
        + " deg; feasible grid points: " + gen.gridPointsFeasible() + "/" + gen.gridPointsTotal());
