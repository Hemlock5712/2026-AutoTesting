...
public class ShooterLookup {
  ...
  private static void buildFlywheel() {
    ...
    flywheelMap.put(3.0, 34.0 + 3.0);
    flywheelMap.put(3.5, 36.0 + 3.0);
    flywheelMap.put(4.0, 39.0 + 3.0);
    flywheelMap.put(4.5, 44.0 + 4.0);
    flywheelMap.put(5.0, 45.0 + 4.0);
