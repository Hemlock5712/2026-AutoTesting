...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
  ...
  @Logged
  public Rotation3d getRobotAngle() {
    return getRotation3d();
  }

  @Logged
  public Double getRobotAngleX() {
    return getRotation3d().getX();
  }

  @Logged
  public Double getRobotAngleY() {
    return getRotation3d().getY();
  }

  @Logged
  public Double getRobotAngleZ() {
