...
public class TunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(10).withKI(0).withKD(0).withKS(1).withKV(0);
  ...
  // Hardware stator current limit (200A per motor, 800A total max)
  // CTRE swerve API uses this to set stator limit, peak torque current, and enables the limit
  private static final Current kSlipCurrent = Amps.of(250.0);
  ...
  private static final double kCoupleRatio = 3.846153846;

  private static final double kDriveGearRatio = 6.593406593;
  ...
  private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.336669921875);
